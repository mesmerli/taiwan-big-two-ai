const I18N = {
    en: {
        ...
        aiUseWebGpuLabel: "Enable Local WebGPU (WebLLM)",

        reviewUseWebGpuLabel: "Use Local WebGPU (WebLLM) for Review",
    ...
    'zh': {
        ...
        aiUseWebGpuLabel: "啟用本地 WebGPU 模式 (WebLLM)",

        reviewUseWebGpuLabel: "使用本地 WebGPU (WebLLM) 進行復盤",

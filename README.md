...
[![Version](https://img.shields.io/badge/Version-1.5.46-blue.svg)](./changelog.md)
...
* **Windows Version**: Browse the **[Windows Release Folder](./release/Windows/)** to download and install the latest **`taiwan-big2-ai_1.5.46_x64_en-US.msi`** (built with Tauri).
* **Android Version**: Browse the **[Android Release Folder](./release/Android/)** to download and install the latest **`twbig2ai-1.5.46.apk`** installation package.
